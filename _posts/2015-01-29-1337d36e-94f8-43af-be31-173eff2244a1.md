...
**NOTE：** 我处于教育网所以安装docker前，我把源换成了清华的。
...
```sh
amy@ubuntu-host2:~$ ping XX.XX.XX.167
PING XX.XX.XX.167 (XX.XX.XX.167) 56(84) bytes of data.
64 bytes from XX.XX.XX.167: icmp_seq=1 ttl=128 time=0.888 ms
64 bytes from XX.XX.XX.167: icmp_seq=2 ttl=128 time=1.33 ms
^C
--- XX.XX.XX.167 ping statistics ---
...
Status: Downloaded newer image for XX.XX.XX.167:5000/ubuntu:latest
```
